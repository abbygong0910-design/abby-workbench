...
const Checkin = {
  ...
  fishCollection: [
    // 普通
    { id:'f01', emoji:'🐠', name:'小丑鱼', desc:'珊瑚礁中常见的可爱居民', rarity:'common', unlockAt:1 },
    { id:'f02', emoji:'🐟', name:'沙丁鱼', desc:'成群结队的旅行者', rarity:'common', unlockAt:3 },
    { id:'f03', emoji:'🐡', name:'河豚', desc:'生气时会鼓成球状', rarity:'common', unlockAt:5 },
    { id:'f04', emoji:'🦐', name:'樱花虾', desc:'浅海中的粉色小精灵', rarity:'common', unlockAt:7 },
    { id:'f05', emoji:'🦀', name:'青蟹', desc:'礁石间的横行霸主', rarity:'common', unlockAt:10 },
    { id:'f06', emoji:'🐙', name:'小章鱼', desc:'聪明又灵活的伪装大师', rarity:'common', unlockAt:12 },
    { id:'f07', emoji:'🪼', name:'水母', desc:'轻盈飘逸的海洋精灵', rarity:'common', unlockAt:15 },
    { id:'f08', emoji:'🐢', name:'海龟', desc:'优雅的长寿旅行者', rarity:'common', unlockAt:18 },
    // 稀有
    ...
    { id:'f28', emoji:'🐚', name:'海螺', desc:'能听到大海的声音', rarity:'common', unlockAt:2 },
    { id:'f29', emoji:'⭐', name:'海星', desc:'五角形的再生大师', rarity:'common', unlockAt:4 },
  ...
  showUnlockAnimation(fishes) {
    ...
    const showNext = () => {
      ...
      cardEl.innerHTML = `
        ...
        <div class="flash-unlock-emoji">${f.emoji}</div>
